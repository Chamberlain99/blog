...
![image-20220509142034644](git.assets/image-20220509142034644.png)
...
-  vsCode集成的stash代码暂存功能

![image-20220509142347548](git.assets/image-20220509142347548.png)



填写备注内容，也可以不填直接Enter

![image-20220509142400968](git.assets/image-20220509142400968.png)

在STASHES菜单中可以看到保存的stash

![image-20220509142423510](git.assets/image-20220509142423510.png)

先点击stash记录旁的小箭头，再点击 apply 或者 pop 都可恢复 stash

![image-20220509142434841](git.assets/image-20220509142434841.png)
